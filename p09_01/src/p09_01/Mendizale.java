...
public class Mendizale {
	 ...
	 * 
	 */
	public Mendizale(String mndzIzenString, int mndzgaraiera1, int mndzgaraiera2, int mndzgaraiera3,
			double mndzBatazbestekoa) {
	...
	public String toString() {
		return "Izena: " + izenaString + ", Garaiera1: " + garaiera1 + ", Garaiera2: " + garaiera2 + ", Garaiera3: "
				+ garaiera3 + ", Batazbestekoa: " + batazbestekoa;
	}
